...
namespace Silk\Customer\Block\Widget;
...
/**
 * Widget for showing customer remark.
 *
 ...
 */
class Remark extends AbstractWidget
{

    /**
     * the attribute code
     */
    const ATTRIBUTE_CODE = 'remark';
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('widget/remark.phtml');
    }
    ...
    /**
     * Check if remark attribute enabled in system
     *
     * @return bool
     */
    ...
    /**
     * Check if remark attribute marked as required
     *
     * @return bool
     */
